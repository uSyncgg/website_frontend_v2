...
function GeneralPaymentForm({ review = false }) {
    ...
    return (
        <div className={`standardContainer ${styles.generalFormContainer}`}>
            ...
            <div className={styles.sectionOneForm}>
                <PaymentForm review={review} formType={formType} reviewEndpoint={reviewEndpoint} id={"test_env"} price={2625}>
