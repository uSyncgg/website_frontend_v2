...
export const ItalianSerieALeague = () => {
    const { data, loading, error } = useEvent("leagues", "Rocket League", "Italian Rocket Champ Leagues - Serie A League");
    ...
    return (
        <div className="standardContainer">
            ...
            />
            <HeaderImage imageUrl={data?.header_img} title={"Italian Series A"} />
