...
export const ItalianSerieBLeague = () => {
    const { data, loading, error } = useEvent("leagues", "Rocket League", "Italian Rocket Champ Leagues - Serie B League");
    ...
    return (
        <div className="standardContainer">
            ...
            />
            <HeaderImage imageUrl={data?.header_img} title={"Italian Series B"} />
