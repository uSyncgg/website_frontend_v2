...
export const FrontierExpertLeague = () => {
    const { data, loading, error } = useEvent("leagues", "Rocket League", "Frontier Doubles Leagues - Expert League");
    ...
    return (
        <div className="standardContainer">
            ...
            />
            <HeaderImage imageUrl={data?.header_img} title={"Expert League"} />
