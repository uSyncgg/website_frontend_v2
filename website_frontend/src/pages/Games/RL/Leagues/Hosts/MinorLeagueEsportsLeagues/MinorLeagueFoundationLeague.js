...
export const MinorLeagueFoundationLeague = () => {
    const { data, loading, error } = useEvent("leagues", "Rocket League", "Minor League Esports - Foundation League");
    ...
    return (
        <div className="standardContainer">
            ...
            />
            <HeaderImage imageUrl={data?.header_img} title={"MLE Foundation"} />
