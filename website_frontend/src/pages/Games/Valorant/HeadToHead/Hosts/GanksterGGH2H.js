    ...
    return (
        <div className="standardContainer">
            ...
            <div className="eventInfoCardContainer">
                <div>
                    <EventInfoCard title={"Fees"} infoList={["Free Scrim Matches"]} footer={<ExternalButton blank={true} title={"Join Now"} path={"https://valorant.gankster.gg/login?session=yes"} />}/>
                </div>
