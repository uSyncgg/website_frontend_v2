...
export const MetaShiftPlatinumLeague = () => {
    const { data, loading, error } = useEvent("leagues", "League of Legends", "MetaShift Platinum League");
    ...
    return (
        <div className="standardContainer">
            ...
            />
            <HeaderImage imageUrl={data?.header_img} title={"MetaShift Platinum League"} />
