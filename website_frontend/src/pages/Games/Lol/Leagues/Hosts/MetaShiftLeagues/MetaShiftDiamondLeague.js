...
export const MetaShiftDiamondLeague = () => {
    const { data, loading, error } = useEvent("leagues", "League of Legends", "MetaShift Diamond League");
    ...
    return (
        <div className="standardContainer">
            ...
            />
            <HeaderImage imageUrl={data?.header_img} title={"MetaShift Diamond League"} />
