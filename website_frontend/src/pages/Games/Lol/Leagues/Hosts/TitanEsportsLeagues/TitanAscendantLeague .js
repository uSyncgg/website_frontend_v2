...
export const TitanAscendantLeague = () => {
    return (
        <div className="standardContainer">
            ...
            />
            <HeaderImage title={"Titan Ascendant League"} imageClass={"titanLOLLeagues"} />
            ...
            <div className="eventInfoCardContainer">
                ...
                <div>
                    <EventInfoCard title={"Entry Fee"} infoList={["$100 per Team", "$50 Forfeit Deposit", "500 LP Cap S16", "300 LP Cap S15 / 14-3"]} footer={<ExternalButton host={"Titan Ascendant League"} blank={true} title={"Join Now"} path={"https://discord.gg/6W6thQEfGn"} />}/>
                </div>
            </div>
