...
const PARENT_NAME = "Blue Otter Leagues";
...
export const BlueOtterLeagues = () => {
    ...
    const headerTitle = parent?.verified ? undefined : (parent?.name || "Blue Otter Leagues");

    return (
        <div className="standardContainer">
            <SeoData
                title={"Blue Otter Leagues - League of Legends"}
