...
export const BlueOtterMastersLeague = () => {
    const { data, loading, error } = useEvent("leagues", "League of Legends", "Blue Otter Masters League");
    ...
    return (
        <div className="standardContainer">
            ...
            />
            <HeaderImage imageUrl={data?.header_img} title={"Blue Otter Masters League"} />
