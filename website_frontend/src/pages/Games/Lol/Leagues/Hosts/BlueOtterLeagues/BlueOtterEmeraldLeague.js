...
export const BlueOtterEmeraldLeague = () => {
    const { data, loading, error } = useEvent("leagues", "League of Legends", "Blue Otter Emerald League");
    ...
    return (
        <div className="standardContainer">
            ...
            />
            <HeaderImage imageUrl={data?.header_img} title={"Blue Otter Emerald League"} />
