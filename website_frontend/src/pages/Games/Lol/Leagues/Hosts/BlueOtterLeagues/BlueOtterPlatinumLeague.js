...
export const BlueOtterPlatinumLeague = () => {
    const { data, loading, error } = useEvent("leagues", "League of Legends", "Blue Otter Platinum League");
    ...
    return (
        <div className="standardContainer">
            ...
            />
            <HeaderImage imageUrl={data?.header_img} title={"Blue Otter Platinum League"} />
